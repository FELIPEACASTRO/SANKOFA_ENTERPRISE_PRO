...
class EnterpriseSecuritySystem:
    ...
    def __init__(self):
        ...
        if not self.jwt_secret:
            logger.warning(
                "SANKOFA_JWT_SECRET não definido, gerando um segredo temporário. Não use em produção."
            )
    ...
    def _init_default_roles(self):
        ...
        default_roles = [
            ...
            },
            {
                ...
                "permissions": json.dumps(["read_transactions", "view_dashboard", "basic_reports"]),
            },
            {
                "name": "auditor",
                "description": "Auditor de compliance",
                "permissions": json.dumps(["view_audit", "read_all", "compliance_reports"]),
            },
        ]
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                access_token = self._generate_access_token(
                    user_id, username, role_name, permissions
                )
    ...
    def _generate_access_token(
        self, user_id: int, username: str, role: str, permissions: str
    ) -> str:
