...
from ..core.entities import (
    ...
    HighValueTransactionSpec,
    HighRiskTransactionSpec,
)
...
class TestFraudAnalysisResult:
    ...
    def test_valid_fraud_result_creation(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=tx_id, is_fraud=True, confidence_score=0.85, processing_time_ms=15.5
        )
    ...
    def test_invalid_confidence_score(self):
        ...
        with pytest.raises(ValueError, match="Confidence score must be between 0 and 1"):
            FraudAnalysisResult(
                transaction_id=TransactionId("TXN_123456789"), is_fraud=True, confidence_score=1.5
            )
    ...
    def test_add_risk_factor(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=TransactionId("TXN_123456789"), is_fraud=True, confidence_score=0.85
        )
    ...
    def test_get_risk_level_critical(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=TransactionId("TXN_123456789"), is_fraud=True, confidence_score=0.95
        )
    ...
    def test_get_risk_level_high(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=TransactionId("TXN_123456789"), is_fraud=True, confidence_score=0.75
        )
    ...
    def test_get_risk_level_medium(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=TransactionId("TXN_123456789"), is_fraud=False, confidence_score=0.45
        )
    ...
    def test_get_risk_level_low(self):
        ...
        result = FraudAnalysisResult(
            transaction_id=TransactionId("TXN_123456789"), is_fraud=False, confidence_score=0.15
        )
...
class TestCustomer:
    ...
    def test_valid_customer_creation(self):
        ...
        customer = Customer(
            id="CUSTOMER_123", email="test@example.com", created_at=datetime.utcnow()
        )
    ...
    def test_invalid_customer_id(self):
        """Test customer ID validation - O(1)"""
        with pytest.raises(ValueError, match="Customer ID is required"):
            Customer(id="", email="test@example.com", created_at=datetime.utcnow())

    def test_invalid_email(self):
        """Test email validation - O(1)"""
        with pytest.raises(ValueError, match="Invalid email format"):
            Customer(id="CUSTOMER_123", email="invalid-email", created_at=datetime.utcnow())
...
class TestTransactionAggregate:
    ...
    def test_process_fraud_analysis(self):
        ...
        fraud_result = FraudAnalysisResult(
            transaction_id=transaction.id, is_fraud=True, confidence_score=0.85
        )
