...
class Transaction:
    ...
    def requires_manual_review(self) -> bool:
        ...
        return (
            ...
            self.is_high_value(Money(Decimal("10000")))
        )
...
class TransactionFactory:
    ...
    def create_aggregate(transaction: Transaction) -> TransactionAggregate:
        ...
        aggregate._add_event(TransactionCreated(
            transaction.id,
            transaction.amount,
...
class AndSpecification(Specification):
    ...
    def is_satisfied_by(self, transaction: Transaction) -> bool:
        return (self.left.is_satisfied_by(transaction) and 
                self.right.is_satisfied_by(transaction))
...
class OrSpecification(Specification):
    ...
    def is_satisfied_by(self, transaction: Transaction) -> bool:
        return (self.left.is_satisfied_by(transaction) or 
                self.right.is_satisfied_by(transaction))