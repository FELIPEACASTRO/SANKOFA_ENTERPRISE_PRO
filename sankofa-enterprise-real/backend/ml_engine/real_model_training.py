...
class RealFraudModelTrainer:
    ...
    def __init__(
        self, data_path="/home/ubuntu/sankofa-enterprise-real/backend/data/real_banking_dataset.csv"
    ):
    ...
    def load_and_prepare_data(self):
        ...
        self.df["valor_zscore"] = (self.df["valor"] - self.df["valor"].mean()) / self.df[
            "valor"
        ].std()
    ...
    def predict_fraud(self, transaction_data):
        ...
        df_trans["valor_zscore"] = (df_trans["valor"] - self.df["valor"].mean()) / self.df[
            "valor"
        ].std()
