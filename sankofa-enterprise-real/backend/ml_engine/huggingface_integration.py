...
class HuggingFaceDatasetLoader:
    ...
    def prepare_for_sankofa(df: pd.DataFrame) -> Dict[str, Any]:
        ...
        return {
            ...
            'metrics': {
                ...
                'fraud_rate': (df_mapped['is_fraud'].sum() / len(df_mapped)) if 'is_fraud' in df_mapped else None
            }
        }
    ...
    def _preprocess(df: pd.DataFrame) -> pd.DataFrame:
        ...
        df = df.dropna(subset=['transaction_amount', 'is_fraud'] 
...
if __name__ == "__main__":
    ...
    print("\n✅ Integração Hugging Face funcionando!")
