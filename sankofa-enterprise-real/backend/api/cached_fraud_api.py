...
class CachedFraudAPI:
    ...
    def _update_metrics(self, cache_hit: bool, response_time: float):
        ...
        if total > 0:
            self.performance_metrics["cache_hit_rate"] = (
                self.performance_metrics["cache_hits"] / total
            )
    ...
    def _generate_input_hash(self, data: Dict[str, Any]) -> str:
        ...
        filtered_data = {
            k: v for k, v in data.items() if k not in ["timestamp", "request_id", "session_id"]
        }
    ...
    def _register_routes(self):
        ...
        def clear_cache():
            ...
            try:
                ...
                return (
                    jsonify(
                        {"success": True, "message": "Cache limpo com sucesso", "data": results}
                    ),
                    200,
                )
        ...
        def warm_up_cache():
            ...
            try:
                ...
                return jsonify({"success": True, "message": "Cache aquecido com sucesso"}), 200
