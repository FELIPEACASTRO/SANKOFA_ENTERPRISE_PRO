...
class RandomForestStrategy(MLModelStrategy):
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        self.feature_names = [
            'amount', 'hour', 'day_of_week', 'merchant_risk',
            'customer_transaction_count', 'amount_zscore',
            'velocity_score', 'location_risk'
        ]
    ...
    async def extract_features(self, transaction: Transaction) -> np.ndarray:
        ...
        return np.array([
            amount, hour, day_of_week, merchant_risk,
            customer_tx_count, amount_zscore, velocity_score, location_risk
        ])
...
class IsolationForestStrategy(MLModelStrategy):
    ...
    def __init__(self):
        ...
        self.feature_names = [
            'amount', 'hour', 'day_of_week', 'merchant_risk',
            'customer_transaction_count', 'velocity_score'
        ]
    ...
    async def extract_features(self, transaction: Transaction) -> np.ndarray:
        ...
        return np.array([
            amount, hour, day_of_week, merchant_risk,
            customer_tx_count, velocity_score
        ])
