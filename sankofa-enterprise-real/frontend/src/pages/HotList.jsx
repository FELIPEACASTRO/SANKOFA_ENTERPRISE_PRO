...
import { UserX, Plus, Edit, Trash2, Search, Download } from 'lucide-react';
...
const HotList = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      console.error('Erro ao salvar entrada HOT:', error);
    }
  };
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Lista HOT</h1>
          <p className="text-gray-600 dark:text-gray-400">Gerenciamento da lista negra para bloqueio direto</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Total HOTs</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Bloqueios Hoje</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border">
        <div className="p-4 border-b">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Entradas HOT ({entries.length})</h2>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {loading ? (
                ...
                <tr>
                  <td colSpan="6" className="px-4 py-8 text-center text-gray-500">Nenhuma entrada HOT encontrada.</td>
                </tr>
              ) : (
      ...
      {showDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Adicionar à Lista HOT</h2>
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <Button onClick={handleSave} className="bg-red-600 hover:bg-red-700 text-white">Adicionar</Button>
            </div>
          </div>
        </div>
      )}
